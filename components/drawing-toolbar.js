            ...
            prefix: [
              {
                type: "button",
                text: "Draw",
                onClick: "switchToDrawMode(event)",
                dataElement: "draw-mode-button",
                class: "btn--white",
              },
            ],
            swatches: [
              { dataBrush: "1", onClick: "changeBrush(1, event)" },
              { dataBrush: "2", onClick: "changeBrush(2, event)" },
              { dataBrush: "3", onClick: "changeBrush(3, event)" },
              { dataBrush: "4", onClick: "changeBrush(4, event)" },
              { dataBrush: "5", onClick: "changeBrush(5, event)" },
              { dataBrush: "6", onClick: "changeBrush(6, event)" },
            ],
          },
        ],
      },
